...
A crop formation is a pattern in a field that looks designed, where the whole question is whether
it means anything — which is the epistemics of the work this site describes. It reads visually too:
circles of varying size along parallel tramlines is sites of varying weight along a sequence.
...
That formation was chosen deliberately. The same catalogue explicitly annotates other 2026
entries as commissioned — Hackpen Hill (26 June, *man-made for TV*) and Journet, France (28 June,
*man-made for exhibition*) — and the Zeals Knoll entry carries no such annotation, with no claimed
authorship found for it. That is the strongest provenance signal available: **unclaimed and
uncommissioned, not verified as non-human** — no formation can be shown to be the latter. If you
swap the design, check the catalogue's annotations first and keep to an unflagged formation.
